...
//进来第一件事添加路径
@WebServlet(name = "QueryMusic",urlPatterns = "/QueryMusic")
public class QueryMusic extends HttpServlet {
    @Override
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        //自定义SQL语句
        String sql = "select * from music_by_id";
        //调用SQL语句 返回数据结构
        ...
        request.getRequestDispatcher("jsp/admin_music.jsp").forward(request,response);
    }
